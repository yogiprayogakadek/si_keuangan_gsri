...
<div class="row">
    <div class="col-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="card-title"><h3>Ubah Data Uang Masuk</h3></div>
                <form action="<?= site_url(route_to('uangmasuk.update')) ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sumber" class="form-control <?= session('errors.sumber') ? 'is-invalid' : '' ?>" id="sumber" placeholder="Masukkan sumber uang" value="<?= esc($data['sumber'])?>">
