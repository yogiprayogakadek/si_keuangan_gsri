...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= site_url(route_to('uangmasuk.print')) ?>" method="post" target="_blank">
                <?= csrf_field() ?>
                        ...
                        <?php foreach($data as $key => $data) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="<?= site_url(route_to('uangmasuk.delete', $data['id'])) ?>" method="post" class="d-inline delete-form">
                                        <?= csrf_field() ?>
