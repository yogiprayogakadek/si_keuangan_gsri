...
<?= $this->section('page-title') ?> Uang Masuk <?= $this->endSection() ?>
<?= $this->section('subpage-title') ?> Tambah Data <?= $this->endSection() ?>
    ...
    <div class="col-12">
        ...
        <div class="card mb-4">
            <div class="position-absolute card-top-buttons">
                <a href="<?= site_url(route_to('uangmasuk.index')) ?>">
            ...
            <div class="card-body">
                <div class="card-title"><h3>Tambah Data Uang Masuk</h3></div>
                <form action="<?= site_url(route_to('uangmasuk.store')) ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jumlah" class="form-control <?= session('errors.jumlah') ? 'is-invalid' : '' ?>" id="jumlah" placeholder="Masukkan jumlah uang" value="<?= old('jumlah') ?>"> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sumber" class="form-control <?= session('errors.sumber') ? 'is-invalid' : '' ?>" id="sumber" placeholder="Masukkan sumber uang" value="<?= old('sumber') ?>">

                        <?php if (session('errors.sumber')) : ?>
                            <div class="invalid-feedback">
                                <?= session('errors.sumber') ?>
                            </div>
                        <?php endif ?>
                    </div>
                    <div class="form-group">
                        <label for="keterangan">Keterangan</label> 
                        <textarea name="keterangan" id="keterangan" class="form-control <?= session('errors.keterangan') ? 'is-invalid' : '' ?>" rows="5" placeholder="Masukkan keterangan"><?= old('keterangan') ?></textarea>
