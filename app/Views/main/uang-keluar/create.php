...
<div class="row">
    <div class="col-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="card-title"><h3>Tambah Data Uang Keluar</h3></div>
                <form action="<?= site_url(route_to('uangkeluar.store')) ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <small id="saldo" class="form-text text-muted"><strong>Sisa saldo saat ini Rp <?= number_format($saldo, 0, ',', '.') ?></strong></small>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tujuan" class="form-control <?= session('errors.tujuan') ? 'is-invalid' : '' ?>" id="tujuan" placeholder="Masukkan tujuan uang" value="<?= old('tujuan') ?>">
