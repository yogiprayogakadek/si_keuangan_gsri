...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-body">
                <h5 class="mb-4">Grafik Keuangan</h5>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-5">
                        ...
                        <div class="chart-container chart">
                            ...
                            <canvas id="editsalesChart" style="display: block; height: 300px; width: 482px;" width="602" height="375" class="chartjs-render-monitor"></canvas>
                        </div>
                    </div>
                    <div class="col-lg-6 mb-5">
