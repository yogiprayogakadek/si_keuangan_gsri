    ...
    !(function () {
      ...
      if (
        ...
        if (document.getElementById("visitChartFull")) {
          ...
          new Chart(D, {
            ...
            options: {
              ...
              tooltips: z,
              scales: {
                yAxes: [{ ticks: { min: 0 }, display: !1 }],
                xAxes: [{ ticks: { min: 0 }, display: !1 }],
              },
            },
          });
        }
        ...
        var R = {
            ...
            scales: {
              yAxes: [{ ticks: { beginAtZero: !0 }, display: !1 }],
              xAxes: [{ display: !1 }],
            },
          },
          L = {
        ...
        if (document.getElementById("scatterChart")) {
          ...
          new Chart(O, {
            ...
            options: {
              ...
              legend: {
                position: "bottom",
                labels: { padding: 30, usePointStyle: !0, fontSize: 12 },
              },
              tooltips: z,
            },
            data: {
      ...
      if ($().DataTable) {
        ...
        $("#rightModal").on("shown.bs.modal", function (e) {
          $("#addToDatatableForm").validate({
            rules: {
              Sales: { required: !0, number: !0, min: 3e3 },
              Stock: { required: !0, number: !0 },
              Category: { required: !0 },
              Name: { required: !0 },
            },
          });
      ...
      "undefined" != typeof noUiSlider &&
        ...
        "undefined" != typeof PerfectScrollbar &&
          $(".scroll").each(function () {
            ...
            new PerfectScrollbar($(this)[0], { suppressScrollX: !0 }).isRtl =
              !1;
          }),
      ...
      if (
        ...
        $().ellipsis && $(".ellipsis").ellipsis({ live: !0 }),
        ...
        if ($(".glide.details").length > 0) {
          var Te = $(".glide.thumbs li").length,
            ...
            ze = new Glide(".glide.thumbs", {
              ...
              direction: o,
              breakpoints: {
                576: { perView: Math.min(4, Te) },
                420: { perView: Math.min(3, Te) },
              },
            });
          function De(e) {
        ...
        if (
          ...
          $(".glide.basic").length > 0 &&
            new Glide(".glide.basic", {
              ...
              perView: 3,
              direction: o,
              breakpoints: { 600: { perView: 1 }, 1e3: { perView: 2 } },
            }).mount(),
